...
$$
\large B = \frac{\mu_0 I}{2\pi r}
$$

Jean-Baptiste Biot & Félix Savart - **Magnetic Field of an Infinite Wire** (1820)

> [!NOTE]
> Calculates the magnetic field generated by an infinitely long straight wire carrying a steady current. [Read more](https://en.wikipedia.org/wiki/Biot%E2%80%93Savart_law)
