...
$$
\large r_L = \frac{0.49 q^{2/3}}{0.6 q^{2/3} + \ln(1 + q^{1/3})}
$$

Peter Eggleton - **Roche Lobe (Eggleton's Approximation)** (1983)

> [!NOTE]
> An accurate approximation for the effective radius of the Roche lobe in a binary star system. [Read more](https://en.wikipedia.org/wiki/Roche_lobe)
