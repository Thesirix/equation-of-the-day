...
$$
\large L = \frac{1}{2} \rho v^2 S C_L
$$

Lord Rayleigh - **Lift Equation** (1877)

> [!NOTE]
> Determines the lift force generated by a lifting surface (like an airplane wing) based on its size, shape, and the density and velocity of the fluid. [Read more](https://en.wikipedia.org/wiki/Lift_(force))
