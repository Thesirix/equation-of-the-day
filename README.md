...
$$
\large n \tau_E \ge \frac{12 k_B T}{\langle \sigma v \rangle Q}
$$

John D. Lawson - **Lawson Criterion** (1955)

> [!NOTE]
> A figure of merit used in nuclear fusion research, comparing the rate of energy generated by fusion reactions to the rate of energy losses. [Read more](https://en.wikipedia.org/wiki/Lawson_criterion)
